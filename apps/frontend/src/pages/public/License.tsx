      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="bg-theme-bg-secondary rounded-2xl shadow-xl shadow-theme-border/20 border border-theme-border p-8 md:p-12 text-theme-text-secondary space-y-6">
            ...
            <p>
              This license applies to the software project &quot;Vibe-message&quot;, including its client
              package, server components, and related source code (collectively referred to as
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              ...
              <li>Operate private instances of the server for internal or application-specific use</li>
            </ul>
            ...
            <p>
              ...
              infrastructure you control. This includes use within private systems, internal
              company tools, or applications built using the Software.
            </p>
            ...
            <p>
              You may not use the Software to operate or offer a public hosted service that
              competes with the official Vibe-message service operated by SailorLabs.in.
            </p>
            ...
            <p className="mt-4">
              Forks created solely for contributing improvements back to the official repository
              are allowed.
            </p>
            ...
            <p>
              Applications using the Software should include reasonable attribution to:
            </p>
            ...
            <p className="uppercase text-sm tracking-wide bg-theme-bg-muted p-4 rounded-lg border border-theme-border mt-2">
              IN NO EVENT SHALL SAILORLABS.IN OR THE AUTHORS BE LIABLE FOR ANY CLAIM, DAMAGES,
            ...
            <p>
              SailorLabs.in reserves the right to update or modify this license in future
