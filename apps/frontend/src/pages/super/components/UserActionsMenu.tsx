    ...
    <>
      ...
      >
        <MenuItem
          ...
          label="View Apps"
          onClick={() => { onClose(); navigate(`/apps?userId=${user.id}`); }}
        />
        ...
        {user.status !== "APPROVED" && (
          <MenuItem
            ...
            variant="success"
            disabled={isSelf}
            onClick={() => { onClose(); onStatusChange(user.id, "APPROVED"); }}
          />
        )}
        ...
        {user.status !== "BANNED" && (
          <MenuItem
            ...
            variant="danger"
            disabled={isSelf}
            onClick={() => { onClose(); onStatusChange(user.id, "BANNED"); }}
          />
        )}
        ...
        <MenuItem
          ...
          label="Set App Limit"
          onClick={() => { onClose(); onSetAppLimit(user); }}
        />
        ...
        <MenuItem
          ...
          variant="warning"
          disabled={isSelf}
          onClick={() => { onClose(); onSendWarning(user); }}
        />
        ...
        {user.role === "ADMIN" && (
          <MenuItem
            ...
            onClick={() => { onClose(); onToggleRetentionPerm(user); }}
          />
        )}
        ...
        {user.role !== "SUPER_ADMIN" ? (
          <MenuItem
            ...
            disabled={isSelf}
            onClick={() => { onClose(); onRoleChange(user.id, "SUPER_ADMIN"); }}
          />
        ) : (
          <MenuItem
            ...
            disabled={isSelf}
            onClick={() => { onClose(); onRoleChange(user.id, "ADMIN"); }}
          />
        )}
