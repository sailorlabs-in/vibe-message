...
export const Docs: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-theme-bg-primary text-theme-text-primary transition-colors duration-300 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      
      {/* Decorative Background Elements */}
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-theme-primary-500/10 blur-[100px] rounded-full pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[30%] h-[30%] bg-theme-accent-500/10 blur-[100px] rounded-full pointer-events-none" />

      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6 tracking-tight">
            Vibe Message <span className="text-transparent bg-clip-text bg-gradient-to-r from-theme-primary-600 dark:from-theme-primary-500 to-theme-accent-500 dark:to-theme-accent-400">Docs</span>
          </h1>
          <p className="text-lg md:text-xl text-theme-text-secondary max-w-3xl mx-auto leading-relaxed">
            The modern, lightweight, and incredibly powerful push notification platform for the web. Drop-in Firebase Cloud Messaging alternative.
          </p>
        </div>
          ...
          {activeTab === "overview" && (
            <div className="animate-fade-in">
              ...
              <p className="text-lg text-theme-text-secondary mb-12 leading-relaxed max-w-4xl">
                Vibe Message is built for modern web applications that need reliable, customizable, and fast push notifications without the heavy baggage of legacy SDKs.
              </p>
              ...
              <div className="bg-theme-bg-primary border border-theme-primary-500/30 rounded-2xl p-8 lg:p-10 relative overflow-hidden shadow-2xl shadow-theme-primary-500/5 group">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                  <div>
                    <h3 className="text-2xl font-bold mb-3 text-theme-text-primary">Ready to build?</h3>
            ...
            <div className="animate-fade-in">
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-xl text-theme-text-secondary leading-relaxed">
                  To use Vibe Message, you need two pieces: a <strong className="text-theme-primary-600 dark:text-theme-primary-400 font-semibold">Frontend</strong> application (to receive messages) and a <strong className="text-theme-primary-600 dark:text-theme-primary-400 font-semibold">Backend</strong> service (to send messages securely).
                </p>
              </div>
              ...
              <div className="grid lg:grid-cols-3 gap-8 relative pb-8">
                ...
                <div className="relative z-10 bg-theme-bg-primary border border-theme-border rounded-2xl p-8 hover:border-theme-primary-500/50 hover:shadow-2xl hover:shadow-theme-primary-500/10 transition-all duration-300 group flex flex-col h-full">
                  <div className="absolute -top-4 -right-2 text-9xl font-extrabold text-theme-text-primary/5 dark:text-theme-primary-500/5 group-hover:text-theme-text-primary/10 dark:group-hover:text-theme-primary-500/10 transition-colors pointer-events-none select-none">1</div>
                  ...
                  <h3 className="text-2xl font-bold text-theme-text-primary mb-4 text-center lg:text-left">Create Application</h3>
                  <p className="text-theme-text-secondary leading-relaxed mb-8 text-center lg:text-left">
                    Register an App in the dashboard to receive your API keys. Keep the secret key completely hidden.
                  </p>
                  <div className="space-y-3 mt-auto">
                    <div className="bg-theme-bg-secondary border border-theme-border rounded-lg p-3 text-sm flex items-center justify-between shadow-sm">
                      ...
                      <span className="text-xs font-semibold px-2 py-1 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 rounded">Public</span>
                    </div>
                    <div className="bg-theme-bg-secondary border border-theme-border rounded-lg p-3 text-sm flex items-center justify-between shadow-sm">
                      <span className="text-theme-text-muted font-mono">publicKey</span>
                      <span className="text-xs font-semibold px-2 py-1 bg-theme-primary-100 dark:bg-theme-primary-900/30 text-theme-primary-700 dark:text-theme-primary-400 rounded">Frontend</span>
                    </div>
                    <div className="bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-900/30 rounded-lg p-3 text-sm flex items-center justify-between shadow-sm">
                      ...
                      <span className="text-xs font-bold px-2 py-1 bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-400 rounded">Backend Only</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative z-10 bg-theme-bg-primary border border-theme-border rounded-2xl p-8 hover:border-theme-primary-500/50 hover:shadow-2xl hover:shadow-theme-primary-500/10 transition-all duration-300 group flex flex-col h-full mt-8 lg:mt-0">
                  <div className="absolute -top-4 -right-2 text-9xl font-extrabold text-theme-text-primary/5 dark:text-theme-primary-500/5 group-hover:text-theme-text-primary/10 dark:group-hover:text-theme-primary-500/10 transition-colors pointer-events-none select-none">2</div>
                  ...
                  <h3 className="text-2xl font-bold text-theme-text-primary mb-4 text-center lg:text-left">Integrate Frontend</h3>
                  <p className="text-theme-text-secondary leading-relaxed mb-6 text-center lg:text-left">
                    Use <code className="text-sm font-mono text-theme-primary-600 dark:text-theme-primary-400">publicKey</code> to authenticate the client browser and register the device with the platform.
                  </p>
...
<span className="text-theme-accent-400">await</span> vibe.registerDevice({'{'}<br/>
&nbsp;&nbsp;externalUserId: <span className="text-theme-warning">'usr_123'</span><br/>
{'}'});
                     </pre>
                  </div>
                </div>
                ...
                {/* Step 3 */}
                <div className="relative z-10 bg-theme-bg-primary border border-theme-border rounded-2xl p-8 hover:border-theme-primary-500/50 hover:shadow-2xl hover:shadow-theme-primary-500/10 transition-all duration-300 group flex flex-col h-full mt-8 lg:mt-0">
                  <div className="absolute -top-4 -right-2 text-9xl font-extrabold text-theme-text-primary/5 dark:text-theme-primary-500/5 group-hover:text-theme-text-primary/10 dark:group-hover:text-theme-primary-500/10 transition-colors pointer-events-none select-none">3</div>
                  ...
                  <h3 className="text-2xl font-bold text-theme-text-primary mb-4 text-center lg:text-left">Trigger from Backend</h3>
                  <p className="text-theme-text-secondary leading-relaxed mb-6 text-center lg:text-left">
                    Use <code className="text-sm font-mono text-red-500">secretKey</code> securely on your server to push messages instantly to the registered devices.
                  </p>
                  <div className="bg-[#1e1e1e] border border-[#2d2d2d] rounded-xl p-5 mt-auto shadow-inner relative overflow-hidden group-hover:border-red-500/30 transition-colors">
                     <pre className="text-sm font-mono text-gray-300 overflow-x-auto relative z-10">
<span className="text-theme-primary-400">await</span> vibe.notification({'{'}<br/>
&nbsp;&nbsp;users: [<span className="text-theme-warning">'usr_123'</span>],<br/>
&nbsp;&nbsp;title: <span className="text-theme-warning">'Hello!'</span><br/>
{'}'});
                     </pre>
                  </div>
                </div>
          ...
          {activeTab === "backend" && (
            <div className="animate-fade-in max-w-4xl mx-auto">
              ...
              <p className="text-lg text-theme-text-secondary mb-10 leading-relaxed p-4 bg-theme-warning/10 border-l-4 border-theme-warning rounded-r-lg">
                Your backend server is responsible for triggering notifications. You should <strong className="text-theme-error">never</strong> expose your <code className="font-mono text-sm bg-theme-bg-secondary px-1 py-0.5 rounded">secretKey</code> to your frontend code.
              </p>

              <div className="space-y-12">
                <div>
                  <h3 className="text-xl font-bold text-theme-text-primary mb-3">1. Install the SDK</h3>
                  <p className="text-theme-text-secondary mb-6">First, you need to install the package via npm in your Node.js backend.</p>
                  <CodeBlock code={`npm install vibe-message`} language="bash" />
                </div>

                <div>
                  <h3 className="text-xl font-bold text-theme-text-primary mb-3">2. Send a Notification via SDK</h3>
                  <p className="text-theme-text-secondary mb-6">Use the Vibe Message SDK in your Node.js server to quickly initialize and dispatch notifications securely.</p>
                  <CodeBlock 
...
console.log(result);`} 
                ...
                <div>
                  <h3 className="text-xl font-bold text-theme-text-primary mb-3">3. Send a Silent Data Payload</h3>
                  <p className="text-theme-text-secondary mb-6">Need to trigger an invisible background refresh on the client? Send a silent payload without a title/body using the <code className="text-sm font-mono bg-theme-bg-muted px-1 py-0.5 border border-theme-border rounded text-theme-primary-500">silentNotification</code> method.</p>
                  <CodeBlock 
                    code={`import { initServerClient } from 'vibe-message';
  ...
  externalUsers: ['user-123']
          ...
          {activeTab === "react" && (
            <div className="animate-fade-in max-w-4xl mx-auto">
              ...
              <div className="space-y-12">
                <div>
                  <h3 className="text-xl font-bold text-theme-text-primary mb-3">1. Install SDK & Generate Worker</h3>
                  <p className="text-theme-text-secondary mb-6">Install the package, and drop the Service Worker file into your public folder using the CLI.</p>
                  <CodeBlock code={`npm install vibe-message\n\nnpx vibe-message init`} language="bash" />
                </div>

                <div>
                  <h3 className="text-xl font-bold text-theme-text-primary mb-3">2. Create a Context Provider</h3>
                  <p className="text-theme-text-secondary mb-6">Create a global React context to manage notification state and permissions.</p>
                  <CodeBlock 
  ...
  return (
    <NotificationContext.Provider value={{ isRegistered, init }}>
      {children}
                ...
                <div>
                  <h3 className="text-xl font-bold text-theme-text-primary mb-3">3. Use Anywhere</h3>
                  <p className="text-theme-text-secondary mb-6">Now you can request permissions and initialize the SDK from any component (e.g. after login)!</p>
                  <CodeBlock 
  ...
  return <button onClick={handleLogin}>Log In</button>;
          ...
          {activeTab === "nextjs" && (
            <div className="animate-fade-in max-w-4xl mx-auto">
              ...
              <p className="text-lg text-theme-text-secondary mb-10 leading-relaxed">
                Integration guide optimized for Next.js 13+ App Router Client Components.
              </p>

              <div className="space-y-12">
                <div>
                  <h3 className="text-xl font-bold text-theme-text-primary mb-3">1. Install SDK & Generate Worker</h3>
                  <p className="text-theme-text-secondary mb-6">Install the package from npm, and generate the <code>push-sw.js</code> file into your Next.js public directory.</p>
                  <CodeBlock code={`npm install vibe-message\n\nnpx vibe-message init`} language="bash" />
                </div>

                <div>
                  <h3 className="text-xl font-bold text-theme-text-primary mb-3">2. Create a Client Component</h3>
                  <p className="text-theme-text-secondary mb-6">Because the SDK uses browser APIs, ensure the wrapper component uses the <code className="font-mono text-sm bg-theme-bg-muted px-1 py-0.5 border border-theme-border rounded text-theme-primary-500">'use client'</code> directive.</p>
                  <CodeBlock 
                    code={`"use client";
...
export default function PushNotifications() {
  ...
  return null; // Empty wrapper
                ...
                <div>
                  <h3 className="text-xl font-bold text-theme-text-primary mb-3">3. Mount inside Layout</h3>
                  <p className="text-theme-text-secondary mb-6">Mount your client component somewhere global, like your root Layout or a specific Dashboard layout wrapper.</p>
                  <CodeBlock 
...
const FeatureCard = ({ icon, title, description }: { icon: string; title: string; description: string }) => (
  <div className="p-8 rounded-2xl border border-theme-border bg-theme-bg-primary hover:border-theme-primary-500/50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group cursor-default">
...
const CodeBlock = ({ code, language }: { code: string, language: string }) => (
  <div className="rounded-xl overflow-hidden border border-[#2d2d2d] bg-[#1e1e1e] shadow-lg">
    <div className="flex items-center justify-between px-4 py-3 border-b border-[#2d2d2d]">
      ...
      <div className="text-xs font-mono text-gray-400 uppercase tracking-widest">{language}</div>
    </div>
