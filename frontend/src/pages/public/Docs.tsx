...
export const Docs: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-theme-bg-primary text-theme-text-primary transition-colors duration-300 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[radial-gradient(circle,_var(--tw-gradient-stops))] from-theme-primary-500 to-transparent opacity-10 rounded-full pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[30%] h-[30%] bg-[radial-gradient(circle,_var(--tw-gradient-stops))] from-theme-accent-500 to-transparent opacity-10 rounded-full pointer-events-none" />
          ...
          {activeTab === "overview" && (
            <div className="animate-fade-in">
              ...
              <p className="text-lg text-theme-text-secondary mb-12 leading-relaxed max-w-4xl">
                ...
                reliable, customizable, and fast push notifications without the
                heavy baggage of legacy SDKs.
              </p>
          ...
          {activeTab === "backend" && (
            <div className="animate-fade-in max-w-4xl mx-auto">
              ...
              <p className="text-lg text-theme-text-secondary mb-10 leading-relaxed p-4 bg-theme-warning/10 border-l-4 border-theme-warning rounded-r-lg">
                Your backend server is responsible for triggering notifications.
                You should <strong className="text-theme-error">never</strong>{" "}
                expose your{" "}
...
console.log(result);`}
                ...
                <div>
                  ...
                  <p className="text-theme-text-secondary mb-6">
                    ...
                    client? Send a silent payload without a title/body using the{" "}
    ...
    <NotificationContext.Provider value={{ isRegistered, init }}>
      {children}
                ...
                <div>
                  ...
                  <p className="text-theme-text-secondary mb-6">
                    Now you can request permissions and initialize the SDK from
                    any component (e.g. after login)!
                  </p>
                  <CodeBlock
...
export default function PushNotifications() {
  ...
  return null; // Empty wrapper
                ...
                <div>
                  ...
                  <p className="text-theme-text-secondary mb-6">
                    Mount your client component somewhere global, like your root
                    Layout or a specific Dashboard layout wrapper.
                  </p>
                  <CodeBlock
